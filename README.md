...
## Senior Frontend Engineer | React & Next.js | AI Product Engineering | Building SaaS, AI Apps & High-Performance Interfaces | Immediate Joiner
...
### CMS, Mobile, Web3 & Product Interfaces
...
![OpenAI](https://img.shields.io/badge/AI%20Interfaces-412991?style=flat-square\&logo=openai\&logoColor=white)
...
### 1. Book That Boat — Premium Yacht Booking Platform

A production-focused yacht and boat booking platform built with **Next.js, React, TypeScript, Payload CMS, Tailwind CSS, and API-driven frontend architecture**.
...
* Built a responsive Next.js customer-facing booking experience
* Integrated Payload CMS for boats, routes, extras, media, menus, reviews, coupons, reservations, owners, subscribers, and structured business content
* Implemented a multi-step booking enquiry flow with validation and live price summary
...
### 2. Pasban — Fleet & Telematics Platform

A React Native and Expo mobile application built for **fleet operations, driver safety, GPS tracking, compliance, reporting, training, and field-service workflows**.
...
### 3. Folionomics — Crypto Portfolio Management Dashboard

A responsive Web3 portfolio dashboard built with **Next.js, React, TypeScript, Redux Toolkit, Material UI, Wagmi, Viem, RainbowKit, and data visualization components**.
...
* Built wallet-connected Web3 dashboard experiences using Wagmi, Viem, and RainbowKit
* Supported Ethereum, Bitcoin, and Solana address workflows, including ENS and `.sol` resolution
* Modeled wallet, bundle, asset, protocol, NFT, transaction, graph, user, and share-link domains with Redux Toolkit
* Created portfolio dashboards with total cards, treemap, sunburst, historical charts, asset tables, protocol views, NFT views, and transaction history
...
| Area                  | Strength                                                                            |
| --------------------- | ----------------------------------------------------------------------------------- |
| Frontend Architecture | Scalable folder structures, reusable components, modular UI systems                 |
| Product UI            | Clean, responsive, business-focused user interfaces                                 |
| React / Next.js       | SSR, App Router, dashboards, booking flows, API-driven products                     |
| TypeScript            | Typed APIs, maintainable frontend logic, safer domain modeling                      |
| React Native          | Mobile-first apps, operational workflows, maps, forms, dashboards                   |
| CMS                   | Payload CMS, structured content, relationships, admin-managed data                  |
| State Management      | Redux Toolkit, Redux Thunk, React Query, SWR, Context                               |
| Performance           | Lazy loading, optimized images, caching, dynamic imports, memoization               |
| Maps & Telematics     | GPS tracking, clustered markers, route playback, operational dashboards             |
| Web3                  | Wallet UI, ENS, Solana support, multi-chain flows, analytics dashboards             |
| UI/UX                 | Figma-to-code, design systems, responsive layouts, customer journeys                |
| Domains               | SaaS, fintech, Web3, booking platforms, fleet management, telematics, AI interfaces |
...
### Building clean, scalable, and business-focused frontend products.
